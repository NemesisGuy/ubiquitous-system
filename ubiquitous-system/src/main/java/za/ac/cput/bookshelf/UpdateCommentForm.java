 ...
 */
public class UpdateCommentForm extends javax.swing.JFrame {
     ...
     * @param book
     */
    public UpdateCommentForm(User user, Book book) {
        this.book = book;
        this.user = user;
        initComponents();
        Dates dates = new Dates();
    ...
    private void initComponents() {
        ...
        jLabelBannerHeading.setText("Update Comment");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCommentForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCommentForm().setVisible(true);
                //  Instant.now() ;
            }
        });
    }
