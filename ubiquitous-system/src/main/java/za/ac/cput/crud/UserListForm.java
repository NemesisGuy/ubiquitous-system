...
import za.ac.cput.bookshelf.UserHistoryForm;
...
// create JTable just once and pass model in the constructor
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && jTable1.getSelectedRow() != -1) {
            ...
            UserHistoryForm userHistoryForm = new UserHistoryForm(usersLoanList, selectedUser);
            userHistoryForm.setVisible(true);
            userHistoryForm.setAlwaysOnTop(true);
            userHistoryForm.setAutoRequestFocus(true);
        }
